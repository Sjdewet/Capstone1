  ...
  <div>
    <div class="container mt-5">
      ...
      <form class="d-flex" role="search">
        ...
        <button class="btn" type="submit" @click="filterProducts()">Search</button>
      </form>

      <div class="row g-5">
        <div class="col" v-for="product in products" :key="product.prodID">
          <div class="card w-50 h-100" v-if="products">
            <a href="/products">
              <div class="card-img">
              ...
              <div class="card-footer">
                <router-link :to="{ name: 'product', params: { prodID: product.prodID } }"><button
                    class="btn btn-outline-light" style="background-color:black">
                    View More
                  </button></router-link>
